...
from Enums.notificationTargetType import NotificationTargetType
...
class NotificationService:
    ...
    @staticmethod
    def create_notification(db:Session, target_type: NotificationTargetType, target_id: int, message: str, title:str,notification_type: NotificationType, datetime: datetime = None):
        """
